...
| 模块 | 功能 |
|:---|:---|
| 📝 **任务管理** | 创建/编辑/删除、子任务、重复任务、四级优先级、标签、自然语言输入 |
| 📁 **清单系统** | 清单分类、文件夹分组、颜色标记、列表/看板/时间线视图 |
| 📅 **日历视图** | 月/周/日/议程四种视图，拖拽调整任务时间 |
| 🔍 **搜索过滤** | 全文搜索、自定义过滤器、智能列表 |
| 🍅 **番茄钟** | 25+5 专注计时、任务关联、白噪音、专注统计 |
| ✅ **习惯追踪** | 每日打卡、连续天数、完成率热力图 |
| 📊 **统计报表** | 完成趋势图、优先级分布、清单统计 |
| ⏰ **倒计时** | 倒计时/纪念日、置顶、进度条 |
| 📐 **四象限** | 艾森豪威尔矩阵，按紧急/重要分类 |
| 🌙 **暗色模式** | 亮色/暗色/跟随系统、10种主色调 |
| ⌨️ **快捷键** | `N` 快速添加、`/` 搜索、`G+T` 跳转今天 |
| 📱 **PWA** | 安装到桌面、离线缓存、推送通知 |
